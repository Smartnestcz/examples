...
#define FIRMWARE_VERSION "Tutorial-PlantWaterer"  // Custom name for this program

WiFiClient espClient;
PubSubClient client(espClient);
int switchPin = 0;
int wateringTime = 5000;  // Select how long do you want the water pump to be active in ms, 5000 = 5 seconds
